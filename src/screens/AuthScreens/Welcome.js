...
const Welcome = ({ navigation }) => {
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <CustomButton onPress={() => navigation.navigate('Registeration')} btnText={'GET STARTED'} />
      ...
      <View style={{ width: wp('90%'), alignSelf: 'center', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('Login')} style={{ borderBottomWidth: 1, borderColor: theme.primaryGreen, marginLeft: 5, padding: 3 }}>
          <Text
            style={{
              color: theme.primaryGreen,
              fontSize: hp('2%'),
